...
public void displayAvailableSeats() {
    ...
    for (Seat seat : seats) {
        if (seat.isAvailable()) {
            System.out.println("Seat Number: " + seat.getSeatNumber() +", Row: " + seat.getRow() + ", Column: " + seat.getColumn());
        }
    }
}
...
public static void main(String[] args) {
    ...
    // SignUp
    System.out.print("SignUp to start your ticket booking");
    ...
    movies.add(new Movie("Kalki 2898 AD"));
    movies.add(new Movie("Maharaja"));
    movies.add(new Movie("The GOAT"));
    movies.add(new Movie("Vettaiyan"));
    movies.add(new Movie("Vidamuyarchi"));
    movies.add(new Movie("Kanguva"));
    ...
    seatSelection.bookSeat(selectedSeatNumber);// Book the selected seat
    ...
    seatSelection.displayAvailableSeats(); // Display updated available seats
    ...
    for (Booking userBooking : userBookings) {
        ...
        System.out.println("Seat Number: " + userBooking.getSeat().getSeatNumber() +", Row: " + userBooking.getSeat().getRow() +", Column: " + userBooking.getSeat().getColumn());
